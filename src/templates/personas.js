        ...
        <div className="container">
          <div className="title">
            <div className="options">
              ...
              <a className="external" target='_blank' rel="noopener noreferrer" href={`https://airtable.com/tbl4zDvg1zEuS33j6/viwluHJfuYdcVx7HR/${pageContext.recordId}`} key={pageContext.recordId}>
              View in Airtable
              </a>
            </div>
