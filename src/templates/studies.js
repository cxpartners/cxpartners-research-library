        ...
        <div className="container">
          <div className="title">
            <div className="options">
              ...
              <a target='_blank' rel="noopener noreferrer" href={pageContext.recordId && `https://airtable.com/tblmB3GpSAgCNKqnY/viwZi3c8qOXxlLza2/${pageContext.recordId}`} className="external">View in Airtable</a>
            </div>
            <h4>Study</h4>
            <h1>{ item.Name }</h1>
          </div>
